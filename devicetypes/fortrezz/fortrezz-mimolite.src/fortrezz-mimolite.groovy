...
metadata {
	...
	tiles (scale: 2) {
        standardTile("switch", "device.switch", width: 4, height: 4, canChangeIcon: true, decoration: "flat") {
            state "on", label: "On", action: "off", icon: "http://swiftlet.technology/wp-content/uploads/2016/06/Switch-On-104-edit.png", backgroundColor: "#ff0000"
...
def configure() {
	...
	delayBetween([
        ...
        zwave.configurationV1.configurationSet(configurationValue: [0], parameterNumber: 3, size: 1).format(), // Input to Relay Mapping. 1 = SIG1 triggered sets Relay
        zwave.configurationV1.configurationSet(configurationValue: [0x59], parameterNumber: 4, size: 1).format(), // Lower Threshold, High
        zwave.configurationV1.configurationSet(configurationValue: [0x49], parameterNumber: 5, size: 1).format(), // Lower Threshold, Low
        zwave.configurationV1.configurationSet(configurationValue: [0x3], parameterNumber: 8, size: 1).format(),
